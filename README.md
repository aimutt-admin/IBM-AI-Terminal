...
🚀 How It Works
The IBM PC sends a message over COM1
The Raspberry Pi receives it via a USB-to-serial adapter
The Python bridge forwards the message to llama-server
The AI generates a response
The response is split into terminal-safe lines
The IBM displays the response in real time
🧪 Example
...
📜 License
MIT - “You can use this code however you want — just give credit and don’t blame me if something breaks.”
